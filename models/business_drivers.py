...
from models.driver_templates import SUPPORTED_DRIVER_PROFILES
...
PROFILE_KEYWORDS = {
    ...
    "Consumer Brand": ["consumer", "brand", "retail", "apparel", "restaurant", "same-store", "store"],
...
def infer_business_driver_profile(dataset: dict, filing_texts: dict | None = None) -> dict:
    """
    ...
    if not scores:
        return {
            ...
            "alternative_profiles": ["Industrial / Hardware", "SaaS / Software", "Consumer Brand"],
        }
